...
variable "tenant_id" {
  type        = string
  description = "Azure tenant ID for provider configuration"
}

variable "prevent_deletion_if_contains_resources" {
  type        = bool
  default     = false
  description = "Prevent deletion if resource group contains resources"
}

variable "cognitive_services_accounts" {
  type = map(object({
    kind                     = string
    location                 = string
    name                     = string
    ...
    custom_question_answering_search_service_id  = optional(string, null)
    custom_question_answering_search_service_key = optional(string, null)
    custom_subdomain_name                        = optional(string, null)
    ...
    local_auth_enabled         = optional(bool, null)
    ...
    metrics_advisor_aad_client_id   = optional(string, null)
    metrics_advisor_aad_tenant_id   = optional(string, null)
    metrics_advisor_super_user_name = optional(string, null)
    metrics_advisor_website_name    = optional(string, null)
    ...
    network_injections = optional(object({
      subnet_id                         = string
      scenario                          = string
      microsoft_managed_network_enabled = optional(bool, false)
    }), null)
    outbound_network_access_restricted = optional(bool, null)
    ...
    qna_runtime_endpoint                    = optional(string, null)
